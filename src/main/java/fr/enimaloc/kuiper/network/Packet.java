...
public interface Packet {
    ...
    enum PacketList {
        ...
        CLIENTBOUND_INITIALIZE_BORDER(Type.CLIENTBOUND, 0x1D, GameState.PLAY),
        CLIENTBOUND_LEVEL_CHUNK_WITH_LIGHT(Type.CLIENTBOUND, 0x1F, GameState.PLAY),
        CLIENTBOUND_LIGHT_UPDATE(Type.CLIENTBOUND, 0x22, GameState.PLAY),
        ...
        CLIENTBOUND_SYNCHRONIZE_POSITION(Type.CLIENTBOUND, 0x36, GameState.PLAY),
        CLIENTBOUND_PLAYER_INFO(Type.CLIENTBOUND, 0x34, GameState.PLAY),
        CLIENTBOUND_SET_DEFAULT_SPAWN_POSITION(Type.CLIENTBOUND, 0x4A, GameState.PLAY),
        CLIENTBOUND_SET_CARRIED_ITEM(Type.CLIENTBOUND, 0x47, GameState.PLAY),
        CLIENTBOUND_SET_CENTER(Type.CLIENTBOUND, 0x48, GameState.PLAY),
