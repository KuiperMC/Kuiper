 ...
 *
 */
public class FlexiblePalette implements SpecializedPalette {
...
//    }
    ...
    public void write(BinaryWriter writer) {
        ...
        if (bitsPerEntry <= maxBitsPerEntry()) { // Palette index
            writer.writeList(paletteToValueList, BinaryWriter::writeVarInt, SizedStrategy.VARINT);
        }
        writer.writeLongArray(values, SizedStrategy.NONE);
    }
    ...
    private void retrieveAll(@NotNull EntryConsumer consumer, boolean consumeEmpty) {
        ...
        final int    dimensionBitCount        = Integer.SIZE - Integer.numberOfLeadingZeros(dimension - 1);
